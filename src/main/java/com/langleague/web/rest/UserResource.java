 ...
 * <p>
 * This class accesses the {@link com.langleague.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    /**
     * {@code POST /admin/users/create} : Create a new user manually (Admin).
     * Use case 49: Create user
     *
     * @param userData the user data (login, password, authorities, activated).
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new user.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/users/create")
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<User> createUserManually(@RequestBody Map<String, Object> userData) throws URISyntaxException {
        LOG.debug("REST request to manually create User");
        AdminUserDTO userDTO = new AdminUserDTO();
        userDTO.setLogin(userData.get("login").toString());
        userDTO.setFirstName(userData.get("firstName") != null ? userData.get("firstName").toString() : "");
        userDTO.setLastName(userData.get("lastName") != null ? userData.get("lastName").toString() : "");
        userDTO.setEmail(userData.get("email").toString());
        userDTO.setLangKey(userData.get("langKey") != null ? userData.get("langKey").toString() : "en");
        if (userData.get("authorities") != null) {
            userDTO.setAuthorities((Set<String>) userData.get("authorities"));
        }
    ...
    /**
     * {@code PUT /admin/users/:login/lock} : Lock a user account.
     * Use case 50: Lock user
     *
    ...
    /**
     * {@code PUT /admin/users/:login/unlock} : Unlock a user account.
     * Use case 51: Unlock user
     *
